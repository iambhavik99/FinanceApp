...
namespace FinanceApp.Domain.Migrations
{
    ...
    [Migration("20240614084439_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceApp.Domain.Models.AccountHistory", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FinanceApp.Domain.Models.AccountHistory", b =>
                {
                    ...
                    b.HasOne("FinanceApp.Domain.Models.Transactions", "Transaction")
                        .WithMany("AccountHistory")
                        .HasForeignKey("transactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinanceApp.Domain.Models.Users", "Users")
                        .WithMany("AccountHistory")
